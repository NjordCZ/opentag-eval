...
/**
 * @defgroup I2C_SSD1306_Functions
 ...
 * @note   @ref I2C_SSD1306_UpdateScreen() must be called after that in order to see updated LCD screen
 * @param  None
 * @retval None
 */
...
/**
 * @brief  Puts integer as asci characters to internal RAM
 * @note   @ref I2C_SSD1306_UpdateScreen() must be called after that in order to see updated LCD screen
 * @param  uint16_t: integer to be written
 * @param  uint8_t: number of digits 1-5, 0 - display the full number without leading zeros
 * @param  *Font: Pointer to @ref TM_FontDef_t structure with used font
 * @param  color: Color used for drawing. This parameter can be a value of @ref SSD1306_COLOR_t enumeration
 * @retval none
 */
